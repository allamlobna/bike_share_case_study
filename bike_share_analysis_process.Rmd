...
project.* \##### **Choose your tools.** - **Excel** - Preview the data
initially, cross-referenced with any errors that arose during the
cleaning process, and added the *ride_length* column. - **R** - Clean,
process, and developed initial data visualizations. - **Tableau** -
Visualize the data and create a dashboard.
